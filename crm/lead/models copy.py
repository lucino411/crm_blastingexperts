...
class Lead(models.Model):
    ...
    company = models.CharField(max_length=100, unique=False, null=True, blank=True)
    legal_nature = models.CharField(max_length=10, choices=LEGAL_NATURE_CHOICES, default='Private')
    ...
    def save(self, *args, **kwargs):
        if not self.created_by and not self.pk:  # Verifica si no existe created_by y si no hay una instancia previa en la base de datos
